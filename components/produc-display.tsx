...
export function ProductDisplay({ productData }: { productData: Product }) {
  ...
  return (
    <div>
      <h1 className="font-serif text-3xl text-center mb-16">All Melts</h1>
      <div
        key="1"
        ...
        <div className="flex-1 px-8">
          ...
          <div className="mt-6 space-y-2 font-serif text-lg">
            <p>
              ...
              Suspendisse sit amet erat sed purus sagittis dapibus. Donec ac
              scelerisque odio. Sed velit sem, pharetra eget nulla vitae,
              molestie pretium eros. Ut imperdiet aliquam augue in auctor.
            </p>
            <p>
              Vivamus volutpat felis sit amet eros tincidunt varius. Fusce
              posuere quis quam et imperdiet. Donec sollicitudin leo at ex
              scelerisque, quis tincidunt magna pulvinar. Nam facilisis enim non
              metus laoreet sollicitudin. Fusce sit amet ullamcorper nulla.
            </p>
          </div>
        </div>
      </div>
